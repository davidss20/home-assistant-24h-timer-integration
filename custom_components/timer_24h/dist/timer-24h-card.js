      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            <!-- Dividing lines -->
            ${Array.from({length:24},(t,e)=>{const i=(360*e/24-90)*(Math.PI/180),a=s+o*Math.cos(i),h=r+o*Math.sin(i),c=s+n*Math.cos(i),l=r+n*Math.sin(i);return V`
                <line 
                  x1="${a}" 
                  y1="${h}" 
                  x2="${c}" 
            ...
            ${Array.from({length:24},(t,e)=>{const o=i.find(t=>t.hour===e&&0===t.minute),h=o?.isActive||!1,c=this.currentTime.getHours()===e&&this.currentTime.getMinutes()<30,l=this.createSectorPath(e,24,a,n,s,r),d=this.getTextPosition(e,24,147.5,s,r);return V`
                <path 
                  d="${l}" 
            ...
            ${Array.from({length:24},(t,e)=>{const n=i.find(t=>t.hour===e&&30===t.minute),h=n?.isActive||!1,c=this.currentTime.getHours()===e&&this.currentTime.getMinutes()>=30,l=this.createSectorPath(e,24,o,a,s,r),d=this.getTextPosition(e,24,82.5,s,r);return V`
                <path 
                  d="${l}" 
