      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            <!-- Dividing lines -->
            ${Array.from({length:24},(t,e)=>{const i=(360*e/24-90)*(Math.PI/180),a=s+r*Math.cos(i),l=n+r*Math.sin(i),c=s+o*Math.cos(i),h=n+o*Math.sin(i);return F`
                <line 
                  x1="${a}" 
                  y1="${l}" 
                  x2="${c}" 
            ...
            ${(()=>{const t=this.getControlledEntitiesStatus();let e="#9ca3af",i="—";this.getHomeStatus()?0===t.total?(e="#d1d5db",i="—"):0===t.active?(e="#ef4444",i=this.localize("off")):t.active===t.total?(e="#10b981",i=this.localize("on")):(e="#f59e0b",i=`${t.active}/${t.total}`):(e="#9ca3af",i="—");const o=this.buildTooltipText();return F`
            ...
            ${Array.from({length:24},(t,e)=>{const r=e,l=i.find(t=>t.hour===r&&0===t.minute),c=l?.isActive||!1,h=this.currentTime.getHours()===r&&this.currentTime.getMinutes()<30,d=this.createSectorPath(r,24,a,o,s,n),p=this.getTextPosition(r,24,147.5,s,n),u=this.getSectorCenterAngleDeg(r,24),g=this.getUprightTextRotationDeg(u),f=p.y+3;return F`
                <path 
                  d="${d}" 
                  fill="${c?"#10b981":"#ffffff"}"
                  stroke="${h?"#ff6b6b":"#e5e7eb"}"
            ...
            ${Array.from({length:24},(t,e)=>{const o=e,l=i.find(t=>t.hour===o&&30===t.minute),c=l?.isActive||!1,h=this.currentTime.getHours()===o&&this.currentTime.getMinutes()>=30,d=this.createSectorPath(o,24,r,a,s,n),p=this.getTextPosition(o,24,82.5,s,n),u=this.getSectorCenterAngleDeg(o,24),g=this.getUprightTextRotationDeg(u),f=p.y+2;return F`
                <path 
                  d="${d}" 
                  fill="${c?"#10b981":"#f8f9fa"}"
                  stroke="${h?"#ff6b6b":"#e5e7eb"}"
