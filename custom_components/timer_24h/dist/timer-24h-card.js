      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            ${Array.from({length:24},(t,e)=>{const n=e,h=i.find(t=>t.hour===n&&0===t.minute),c=h?.isActive||!1,l=this.currentTime.getHours()===n&&this.currentTime.getMinutes()<30,d=this.createSectorPath(n,24,a,o,s,r),p=this.getTextPosition(n,24,147.5,s,r);return V`
                <path 
                  d="${d}" 
            ...
            ${Array.from({length:24},(t,e)=>{const o=e,h=i.find(t=>t.hour===o&&30===t.minute),c=h?.isActive||!1,l=this.currentTime.getHours()===o&&this.currentTime.getMinutes()>=30,d=this.createSectorPath(o,24,n,a,s,r),p=this.getTextPosition(o,24,82.5,s,r);return V`
                <path 
                  d="${d}" 
