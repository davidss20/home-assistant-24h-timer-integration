      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            <!-- Dividing lines -->
            ${Array.from({length:24},(t,e)=>{const i=(360*e/24-90)*(Math.PI/180),a=s+n*Math.cos(i),c=r+n*Math.sin(i),h=s+o*Math.cos(i),l=r+o*Math.sin(i);return V`
                <line 
                  x1="${a}" 
                  y1="${c}" 
                  x2="${h}" 
            ...
            ${Array.from({length:24},(t,e)=>{const n=e,c=i.find(t=>t.hour===n&&0===t.minute),h=c?.isActive||!1,l=this.currentTime.getHours()===n&&this.currentTime.getMinutes()<30,d=this.createSectorPath(n,24,a,o,s,r),p=this.getTextPosition(n,24,147.5,s,r);return V`
                <path 
                  d="${d}" 
            ...
            ${Array.from({length:24},(t,e)=>{const o=e,c=i.find(t=>t.hour===o&&30===t.minute),h=c?.isActive||!1,l=this.currentTime.getHours()===o&&this.currentTime.getMinutes()>=30,d=this.createSectorPath(o,24,n,a,s,r),p=this.getTextPosition(o,24,82.5,s,r);return V`
                <path 
                  d="${d}" 
