      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            ${Array.from({length:24},(t,e)=>{const r=e,l=i.find(t=>t.hour===r&&0===t.minute),c=l?.isActive||!1,h=this.currentTime.getHours()===r&&this.currentTime.getMinutes()<30,d=this.createSectorPath(r,24,a,n,s,o),p=this.getTextPosition(r,24,147.5,s,o),g=this.getSectorCenterAngleDeg(r,24),u=this.getUprightTextRotationDeg(g),f=p.y+3;return W`
                <path 
                  d="${d}" 
                  fill="${c?"#10b981":"#ffffff"}"
                  stroke="${h?"#ff6b6b":"#e5e7eb"}"
            ...
            ${Array.from({length:24},(t,e)=>{const n=e,l=i.find(t=>t.hour===n&&30===t.minute),c=l?.isActive||!1,h=this.currentTime.getHours()===n&&this.currentTime.getMinutes()>=30,d=this.createSectorPath(n,24,r,a,s,o),p=this.getTextPosition(n,24,82.5,s,o),g=this.getSectorCenterAngleDeg(n,24),u=this.getUprightTextRotationDeg(g),f=p.y+2;return W`
                <path 
                  d="${d}" 
                  fill="${c?"#10b981":"#f8f9fa"}"
                  stroke="${h?"#ff6b6b":"#e5e7eb"}"
