      ...
      <ha-card>
        ...
        <div class="timer-container">
          <svg class="timer-svg" viewBox="0 0 400 400">
            ...
            <!-- Dividing lines -->
            ${Array.from({length:24},(t,e)=>{const i=(360*e/24-90)*(Math.PI/180),a=s+n*Math.cos(i),c=o+n*Math.sin(i),l=s+r*Math.cos(i),h=o+r*Math.sin(i);return V`
                <line 
                  x1="${a}" 
                  y1="${c}" 
                  x2="${l}" 
            ...
            ${(()=>{const t=this.getControlledEntitiesStatus();let e="#9ca3af",i="—";return this.getHomeStatus()?0===t.total?(e="#d1d5db",i="—"):0===t.active?(e="#ef4444",i="OFF"):t.active===t.total?(e="#10b981",i="ON"):(e="#f59e0b",i=`${t.active}/${t.total}`):(e="#9ca3af",i="—"),V`
            ...
            ${Array.from({length:24},(t,e)=>{const n=e,c=i.find(t=>t.hour===n&&0===t.minute),l=c?.isActive||!1,h=this.currentTime.getHours()===n&&this.currentTime.getMinutes()<30,d=this.createSectorPath(n,24,a,r,s,o),p=this.getTextPosition(n,24,147.5,s,o);return V`
                <path 
                  d="${d}" 
            ...
            ${Array.from({length:24},(t,e)=>{const r=e,c=i.find(t=>t.hour===r&&30===t.minute),l=c?.isActive||!1,h=this.currentTime.getHours()===r&&this.currentTime.getMinutes()>=30,d=this.createSectorPath(r,24,n,a,s,o),p=this.getTextPosition(r,24,82.5,s,o);return V`
                <path 
                  d="${d}" 
